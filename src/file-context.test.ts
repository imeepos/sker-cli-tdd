...
describe('FileContext', () => {
  ...
  beforeEach(async () => {
    ...
    await fs.promises.writeFile(testFilePath, 'test content for file context', 'utf8');
  });
...
class MyClass {}`;
    ...
    it('应该支持路径相关方法', () => {
      ...
      expect(fileContext.getRelativePath(rootContext)).toBe(path.relative('/project', '/project/src/index.ts'));
